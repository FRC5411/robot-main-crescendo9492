...
public class ModuleJson {
   ...
   *
   * <p>Conversion factor applied to the motor controllers PID loops. Can be calculated with {@link
   * swervelib.math.SwerveMath#calculateDegreesPerSteeringRotation(double, double)} for angle motors
