...
public class SwerveModuleConfiguration {
   ...
   * swervelib.math.SwerveMath#calculateMetersPerRotation(double, double, double)} and {@link
   * swervelib.math.SwerveMath#calculateDegreesPerSteeringRotation(double, double)} respectively to
